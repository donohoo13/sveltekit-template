...
<article class="article-container section-spacing privacy-policy">
	...
	<section>
		<h2 id="logging">Log Files</h2>
		<p>
			Donohoo Dev follows a standard procedure of using log files. These files log visitors
	...
	<section>
		...
		<p>
			Like any other website, Donohoo Dev uses 'cookies'. These cookies are used to store
	...
	<section>
		...
		<p>
			...
			Donohoo Dev, which are sent directly to users' browser. They automatically receive your
		...
		<p>
			Note that Donohoo Dev has no access to or control over these cookies that are used by
			third-party advertisers.
		</p>
	</section>

	<section>
		<h2 id="third-party">Third Party Privacy Policies</h2>
		<p>
			Donohoo Dev's Privacy Policy does not apply to other advertisers or websites. Thus, we
	...
	<section>
		...
		<p>
			Donohoo Dev does not knowingly collect any Personal Identifiable Information from
	...
	<section>
		<h2 id="online-only">Online Privacy Policy Only</h2>
		<p>
			This Privacy Policy applies only to our online activities and is valid for visitors to
			our website with regards to the information that they shared and/or collect in Donohoo
			Dev. This policy is not applicable to any information collected offline or via channels
